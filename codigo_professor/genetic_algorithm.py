...
if __name__ == '__main__':
    ...
    for generation in range(N_GENERATIONS):
        ...
        new_population = [population[0]]  # Keep the best individual: ELITISM (Essa populacion entre chaves é a nova populacao, e o primeiro elemento é o melhor individuo da populacao anterior)
